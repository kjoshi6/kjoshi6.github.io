document.addEventListener("DOMContentLoaded", function () {
    ...
    const cards = [
        ...
        { name: "Ace of Swords", image: "", description: "Mental clarity, new ideas, and breakthroughs." },
        { name: "Two of Swords", image: "", description: "Indecision, choices, and inner conflict." },
        { name: "Three of Swords", image: "", description: "Heartbreak, emotional pain, and sorrow." },
        { name: "Four of Swords", image: "", description: "Rest, healing, and contemplation." },
        { name: "Five of Swords", image: "", description: "Conflict, betrayal, and hollow victory." },
        { name: "Six of Swords", image: "", description: "Moving on, transition, and overcoming challenges." },
        { name: "Seven of Swords", image: "", description: "Deception, stealth, and dishonesty." },
        { name: "Eight of Swords", image: "", description: "Feeling trapped, restricted, and helpless." },
        { name: "Nine of Swords", image: "", description: "Anxiety, fear, and sleepless nights." },
        { name: "Ten of Swords", image: "", description: "Betrayal, painful endings, and rock bottom." },
        { name: "Page of Swords", image: "", description: "Curiosity, observation, and new ideas." },
