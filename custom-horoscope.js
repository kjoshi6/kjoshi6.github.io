...
const horoscopes = {
    ...
    gemini: [
        ...
        "You are demon wrapped up in clown suit"
    ],
    cancer: [
    ...
    leo: [
        ...
        "The world does actually revolve around you... somehow.."
    ],
    virgo: [
...
function displayHoroscope() {
    ...
    if (selectedSign) {
        // pick one random message from the array
        const messages = horoscopes[selectedSign];
        const randomMessage = messages[Math.floor(Math.random() * messages.length)];
        resultDiv.innerHTML = `<p>Your horoscope: ${randomMessage}</p>`;
    } else {
